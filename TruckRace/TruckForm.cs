...
namespace TruckRace
{
    public partial class TruckForm : Form
    {
        ...
        private void SetupRaceTrack()
        {
            ...
            Racers[0] = pFactory.getRacer("Arshbal", MaximumBet, ArshbalBet); //getting Arshbal object from factory class
        ...
        private void ArshbalButton_CheckedChanged(object sender, EventArgs e)
        {
