...
namespace TruckRace
{
    ...
    public class Arshbal : Racer
    {
        public Arshbal(Bet MyBet, Label MaximumBet, int Cash, Label MyLabel) : base(MyBet, MaximumBet, Cash, MyLabel)
        {
        }
    ...
    public class Factory
    {
        public Racer getRacer(String Name, Label MaximumBet, Label bet)
        {
            ...
            {
                case "arshbal":
                    Obj_race = new Arshbal(null, MaximumBet, 50, bet);
                    break;
